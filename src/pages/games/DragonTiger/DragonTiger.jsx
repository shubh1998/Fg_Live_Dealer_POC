...
export const DragonTiger = () => {
  ...
  return (
    ...
    (
      <div id='root-main'>
        <LiveStream STREAM_URL='http://44.202.140.218/live/DT.flv' id='game-live-video'>
          <div style={{ position: 'absolute', top: timer > 0 ? '7%' : '12%', left: '11%', transform: 'scale(0.8)' }}>

            <RootContainer timerActive={timer === 0 && (!dragonCard && !tigerCard)}>
              {timer > 0 && (
                <TimerDiv>
